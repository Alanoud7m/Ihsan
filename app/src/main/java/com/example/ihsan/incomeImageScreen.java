...
public class incomeImageScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_image_screen);
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                StorageReference viewHousingRef = storageReference.child("BeneficiariesDocs/" + documentSnapshot.getString("email") + "/income.jpg");
