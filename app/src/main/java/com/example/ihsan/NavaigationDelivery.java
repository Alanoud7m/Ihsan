...
public class NavaigationDelivery extends AppCompatActivity  {
    MenuItem miLogout;
...
//Navigation coding start
        ...
        actionBarDrawerToggle= new ActionBarDrawerToggle(NavaigationDelivery.this,drawerLayout,R.string.drawer_open,R.string.drawer_close);
    ...
    public void UserMenuSelected(MenuItem menuItem){
        switch (menuItem.getItemId()) {
            ...
            case  R.id.account:
                startActivity(new Intent(NavaigationDelivery.this, d_ViewAccount.class));
            ...
            case  R.id.call:
                ...
                alertDialogBuilder.setNegativeButton("أغلاق", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(NavaigationDelivery.this,"إلغاء الأمر",Toast.LENGTH_LONG).show();
                    }
                });
