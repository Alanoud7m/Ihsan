...
public class NavaigationCharity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button verifyBBtn= findViewById(R.id.verifyBBtn);
        verifyBBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(),VerifyListActivity.class));
            }
        });
